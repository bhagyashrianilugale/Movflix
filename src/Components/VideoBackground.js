...
const VideoBackground = ({movieId})=>{
   ...
   return(
      ...
      <>
        <div className="w-full h-full lg:pb-0">
         <div>
            <div className="w-full h-[6%] md:h-[12%] lg:h-[12%] bg-black absolute"></div>
            <iframe 
                    className="w-full aspect-video h-full overflow-hidden lg:pt-0" 
