...
const GptSearchBar = () => {
  ...
  return (
    ...
    <div className="pt-[20%] lg:pt-[10%]">
         <form className="grid grid-cols-12 mt-[10%] lg:mt-0 mx-10 lg:mx-[20%] bg-black rounded-lg" onSubmit={(e)=> e.preventDefault()}>
            <input type="text" 
            ...
            <button className="lg:py-2 p-0 lg:px-2 bg-red-800 col-span-2 text-white m-2 rounded-lg" onClick={handleGptSearchClick}>
              {lang[langkey].search}
            </button>
        </form>
    </div>
